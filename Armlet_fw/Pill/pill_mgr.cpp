...
//                Printf("Pill: %d\r", PillMgr.Pill.TypeInt32);
                EvtQMain.SendWaitingAbility(EvtMsg_t(evtIdPillConnected, &PillMgr.Pill), MS2ST(999));
                break;
            case pillJustDisconnected:
//                Printf("Pill Discon\r");
                EvtQMain.SendWaitingAbility(EvtMsg_t(evtIdPillDisconnected), MS2ST(999));
                break;
            case pillNoChange:
                break;
        }
